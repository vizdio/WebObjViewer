...
export class SceneController {
  ...
  constructor(primaryMesh: Mesh) {
    this.objects = [
      {
        mesh: primaryMesh,
        transform: createTransform([0, 0, 0], [0.15, 0.35, 0], [0.92, 0.92, 0.92]),
      },
      {
        mesh: createLightMarkerMesh(),
        transform: createTransform([0, 0.25, 6.5], [0, 0, 0], [0.24, 0.24, 0.24]),
      },
    ]
  }
  ...
  getRenderableObjects(): SceneObject[] {
    return this.lightMarkerVisible ? this.objects : this.objects.slice(0, 1)
  }
}
