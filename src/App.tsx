...
function App() {
  ...
  const [qualitySectionCollapsed, setQualitySectionCollapsed] = useState(false)
  const [lightingSectionCollapsed, setLightingSectionCollapsed] = useState(false)
  const [transformSectionCollapsed, setTransformSectionCollapsed] = useState(false)
